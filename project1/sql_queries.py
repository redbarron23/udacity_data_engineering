...
# INSERT RECORDS
songplay_table_insert = ("""INSERT INTO songplays ( start_time, user_id, level, artist_id, song_id, session_id, location, user_agent) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)""")
...
#time_table_insert = ("""INSERT INTO time (start_time, hour, day, week, month, year, weekday) #VALUES (TIMESTAMP 'epoch' + (%s * INTERVAL '1 second'), %s, %s, %s, %s, %s, %s, %s) ON #CONFLICT (start_time) DO NOTHING""")
